...
const ScheduledTaskModal = ({
    ...
    useFormRequest(form, ["form-request", "web/src/pages/sysops/ScheduledTaskModal.tsx", open, id], get, {enabled: open});
    return <Modal
    ...
    >
        <Form form={form} clearOnDestroy={true} layout="vertical">
            ...
            <Form.Item label={t('general.name')} name={'name'} required={true}>
                <Input />
            </Form.Item>
            <Row gutter={16}>
                <Col span={12}>
